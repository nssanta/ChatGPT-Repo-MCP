...
_FIELD_TYPES: dict[str, Any] = {
    ...
    "jobs": list[Any], "operations": list[Any], "used": int, "capacity": int,
    "operation_id": str, "cancel_requested": bool, "cancelled": bool, "session_id": str, "artifact": dict[str, Any], "data": str,
