...
func testSettingsForTools(root string) config.Settings {
	return config.Settings{
		...
		DefaultInlineOutputBytes: 64 * 1024, MaxCommandOutputChars: 100000, CommandTimeout: 5 * time.Second, CommandJobTimeout: 4 * time.Hour, SubprocessTimeout: 5 * time.Second,
